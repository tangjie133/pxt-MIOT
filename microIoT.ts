...
const OBLOQ_MQTT_EASY_IOT_SERVER_TK1 = "quan.suning.com"
...
*/
    ...
    export function GET1(time: number): string {
        microIoT_setPara(SETHTTP_IP, OBLOQ_MQTT_EASY_IOT_SERVER_TK1)
        let tempStr = "getSysTime.do"
        microIoT_ParaRunCommand(GET_URL, tempStr);
        return microIoT_http_wait_request(time);
    }
    ...
    //% weight=60
    //%  block="Init"
    export function getInit():void{
       
    }
    //% weight=60
    //%  block="year"
    export function year(): string {
        let x = GET1(1000).substr(-16, 4)
        return x
    }
    ...
    export function hour(): string {
        let x = GET1(1000).substr(-8, 2)
        return x
    }

    //% weight=60
    //%  block="min"
    export function min(): string {
        let x = GET1(1000).substr(-6, 2)
        return x
    }
    //% weight=60
    //%  block="second"
    export function second(): string {
        let x = GET1(1000).substr(-4, 2)
        return x
    }
}
